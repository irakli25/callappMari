...
class news extends dbClass{
    ...
    public function GET($colCount,$cols,$status_id,$startDate, $endDate){
        ...
        if(empty($status_id) || $status_id == 1 || $status_id == 3){
            ...
            $datefilter = "AND news.end_date BETWEEN '$startDate' AND '$endDate' ";
        }
        ...
        parent::setQuery("   SELECT	    news.id,
                        ...
                        WHERE news.actived = 1 $filter $datefilter

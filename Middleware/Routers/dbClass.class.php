...
class dbClass extends AsteriskManager{
     ...
     * @throws Exception
     */
    public function __construct($host=MYSQLSERVERIP, $user=MYSQLUSER, $dbpassword=MYSQLPASS, $db=MYSQLDB, $port=MYSQLPORT, $charset=MYSQLCHARSET){

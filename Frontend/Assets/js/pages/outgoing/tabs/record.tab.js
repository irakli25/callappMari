...
export default class TabRecord extends Tdg {
    constructor() {
        ...
        self.Outgoing.tab = [];
        self.Outgoing.tab.TabRecord = this;
    ...
    checkfordata() {
        ...
        if (self.OutgoingModal.fromtask) {
    ...
    init = () => {
        ...
        self.Outgoing.TabRecord = this.CreateElement({
            element: "div",
            style: {
                gap: '10px',
                display: 'grid',
        ...
        this.state.fieldSet = self.Outgoing.TabRecord;

        this.append(this.state.interfaceName, this.state.fieldSet);

        this.append(self.Outgoing.TabRecord, this.buildRecords());
        this.append(self.Outgoing.TabRecord, this.buildIncCall());
        this.append(self.Outgoing.TabRecord, this.buildOutcCall());
    ...
    destroy = () => {
        ...
        if (!self.Outgoing.TabMail) return false;
        self.Outgoing.TabMail.remove();

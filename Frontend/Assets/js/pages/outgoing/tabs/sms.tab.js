...
export default class TabSms extends Tdg {
    ...
    init = () => {
        ...
        self.Outgoing.TabSms = this.CreateElement({
            element: "div",
            attributes: ["fieldset"],
            title: "SMS",
            style: {
        ...
        this.state.fieldSet = self.Outgoing.TabSms;
    ...
    destroy = () => {
        ...
        if (!self.Outgoing.TabSms) return false;
        self.Outgoing.TabSms.remove();

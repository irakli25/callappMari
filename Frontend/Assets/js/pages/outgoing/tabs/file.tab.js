...
export default class TabFile extends Tdg {
    ...
    constructor() {
        ...
        self.Outgoing.tab = [];
        self.Outgoing.tab.TabFile = this;
    ...
    init = () => {
        ...
        self.Outgoing.TabFile = this.CreateElement({
            element: "div",
            attributes: ["fieldset"],
            title: "ფაილები",
            style: {
        ...
        this.state.fieldSet = self.Outgoing.TabFile;
    ...
    destroy = () => {
        ...
        if (!self.Outgoing.TabFile) return false;
        self.Outgoing.TabFile.remove();

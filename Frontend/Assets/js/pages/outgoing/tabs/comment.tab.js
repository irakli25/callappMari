...
export default class TabComment extends Tdg {
    ...
    constructor() {
        ...
        self.Outgoing.tab = [];
        self.Outgoing.tab.TabComment = this;
    ...
    init = async () => {
        ...
        self.Outgoing.TabComment = this.CreateElement({
            element: "div",
            style: {
                gap: '10px',
        ...
        this.state.fieldSet = self.Outgoing.TabComment;
    ...
    destroy = () => {
        ...
        if (!self.Outgoing.TabComment) return false;
        self.Outgoing.TabComment.remove();

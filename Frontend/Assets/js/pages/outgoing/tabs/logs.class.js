...
export default class TabLogs extends Tdg {
    ...
    constructor() {
        ...
        self.Outgoing.tab = [];
        self.Outgoing.tab.TabLogs = this;
    ...
    init = () => {
        ...
        self.Outgoing.TabLogs = this.CreateElement({
            element: "div",
            attributes: ["fieldset"],
            title: "ლოგები",
            style: {
        ...
        this.state.fieldSet = self.Outgoing.TabLogs;
    ...
    destroy = () => {
        ...
        if (!self.Outgoing.TabLogs) return false;
        self.Outgoing.TabLogs.remove();

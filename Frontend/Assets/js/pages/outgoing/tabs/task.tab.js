...
export default class TabTask extends Tdg {
    ...
    constructor() {
        ...
        self.Outgoing.tab = [];
        self.Outgoing.tab.TabTask = this;
    ...
    init = () => {
        ...
        self.Outgoing.TabTask = this.CreateElement({
            element: "div",
            attributes: ["fieldset"],
            title: "დავალება",
            style: {
        ...
        this.state.fieldSet = self.Outgoing.TabTask;
    ...
    destroy = () => {
        ...
        if (!self.Outgoing.TabTask) return false;
        self.Outgoing.TabTask.remove();

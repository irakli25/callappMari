...
import { kendo_SelectedID, kendo__refresh, kendo__destroy } from "../../../helpers/kendo.helper.js";
...
export default class TabHistory extends Tdg {
    ...
    constructor() {
        ...
        self.Outgoing.tab = [];
        self.Outgoing.tab.history = this;
    ...
    init = () => {
        ...
        self.Outgoing.History = this.CreateElement({
            element: "div",
            attributes: ["fieldset"],
            class: "historyTab",
            title: "ისტორია",
        ...
        this.state.fieldSet = self.Outgoing.History;
    ...
    destroy = () => {
        ...
        if (!self.Outgoing.History) return false;
        self.Outgoing.History.remove();

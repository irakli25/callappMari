...
import { kendo_SelectedID, kendo__refresh, kendo_SelectedText } from "../../../helpers/kendo.helper.js";
...
export default class TabMail extends Tdg {
    ...
    constructor() {
        ...
        self.Outgoing.tab = [];
        self.Outgoing.tab.TabMail = this;
    ...
    init = () => {
        ...
        self.Outgoing.TabMail = this.CreateElement({
            element: "div",
            attributes: ["fieldset"],
            title: "Email",
            style: {
        ...
        this.state.fieldSet = self.Outgoing.TabMail;
                            ...
                            onclick: async () => {
                                ...
                                await this.getResponse({
                                    ...
                                    if (data[0].status) {
                                        ...
                                        new Uploader({}).clean();
                                        self.Outgoing.tab.TabMail.state.requestData = [];
                                    } else {

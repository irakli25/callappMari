...
export default class TabDetail extends Tdg {
    ...
    constructor() {
        ...
        self.Incomming.tab = [];
        self.Incomming.tab.TabDetail = this;
    ...
    init = async () => {
        ...
        await this.getResponse({
            ...
            self.Incomming.tab.TabDetail.state.data = data;

            self.Incomming.TabDetail = this.CreateElement({
                element: "div",
                attributes: ["fieldset"],
                title: "დეტალები",
                style: {
            ...
            this.state.fieldSet = self.Incomming.TabDetail;
    ...
    buildInputOperator = () => {
        ...
        this.state.element.inputoperator = new Input({
            ...
            value: self.Incomming.tab.TabDetail.state.data.operator ? self.Incomming.tab.TabDetail.state.data.operator : "",
            column: "2",
            id: "oeprator_inp",
            disabled: "true",
            style: {
    ...
    buildInputDate = () => {
        this.state.element.inputDate = new Input({
            ...
            value: self.Incomming.tab.TabDetail.state.data.datetime ? self.Incomming.tab.TabDetail.state.data.datetime : "",
            column: "2",
            id: "date_inp",
            disabled: "true",
            style: {
    ...
    buildInputMomNuber = () => {
        this.state.element.inputmomnumber = new Input({
            ...
            column: "2",
            value: self.Incomming.tab.TabDetail.state.data.id ? self.Incomming.tab.TabDetail.state.data.id : "",
            id: "momnum_inp",
            disabled: "true",
            style: {
                width: "210px"
    ...
    buildInputWaitTime = () => {
        this.state.element.inputwaittime = new Input({
            ...
            column: "2",
            value: self.Incomming.tab.TabDetail.state.data.wait_time ? self.Incomming.tab.TabDetail.state.data.wait_time : "",
            id: "waittime_inp",
            disabled: "true",
            style: {
                width: "210px"
    ...
    buildInputTalkTime = () => {
        this.state.element.inputtalktime = new Input({
            ...
            column: "2",
            value: self.Incomming.tab.TabDetail.state.data.talk_time ? self.Incomming.tab.TabDetail.state.data.talk_time : "",
            id: "talktime_inp",
            disabled: "true",
            style: {
                width: "210px"
    ...
    buildInputDamushXan = () => {
        this.state.element.inputdamushxan = new Input({
            ...
            column: "2",
            value: self.Incomming.tab.TabDetail.state.data.processed_time ? self.Incomming.tab.TabDetail.state.data.processed_time : "",
            id: "damushxan_inp",
            disabled: "true",
            style: {
                width: "210px"
    ...
    destroy = () => {
        ...
        if (!self.Incomming.TabDetail) return false;
        self.Incomming.TabDetail.remove();

...
export default class TabComment extends Tdg{
    ...
    constructor(){
        ...
        self.Incomming.tab = [];
        self.Incomming.tab.TabComment = this;
    ...
    init = async () => {
        ...
        self.Incomming.TabComment = this.CreateElement({
            element: "div",
            style:{
                gap: '10px',
        ...
        this.state.fieldSet = self.Incomming.TabComment;
    ...
    destroy = () => {
        ...
        if(!self.Incomming.TabComment) return false;
        self.Incomming.TabComment.remove();

...
import GivenInformationModal from "./givenInformation.modal.js";
...
export default class WorkGround extends Tdg {
    ...
    getTabContentForTask = async (key) => {
        switch (key) {
            ...
            case "question":
                ...
                break;
            case "sms":
                new TabSms().init( (self.WorkGround.state.inputs.length < 1) ? '' : self.WorkGround.state.inputs[0].value)
                break;
            case "mail":
                new TabMail().init();
                break;
    ...
    checkAndSaveInfoTab = () => {
        ...
        if(this.state.oldTab == 'info'){
            ...
            self.Incomming.incommingSaveButton("",{},0);
        }
    ...
    handleTabClick = function () {
        ...
        switch (key) {
            ...
            case "question":
                ...
                break;
            case "sms":
                new TabSms().init(self.WorkGround.state.inputs[0].value)
...
console.log(this.state.prop.queue_number)
        if(this.state.prop.queue_number == '114'){
        ...
        switch (input.input_type) {
            ...
            case "multilevelselect":
                    ...
                    this.append(fieldset, level_1, false, (cb) => {
                        ...
                        console.log(this.state.multilevels)
                    })
                    ...
                    this.state.additionals = input.additionals;
            ...
            default:
                if (typeof input.multipleButtons != 'undefined') {
                    ...
                    if (input.multipleButtons.buttonAdd) {
                        ...
                        let buttonAddTwo = this.CreateElement({
                            element: "div",
                            class: "buttonAddTwo",
                            children: `<img src="Frontend/Assets/images/icons/info-2.svg"><div class="buttonAddTwo-info">4/4</div>`,
                            onclick: async () => {
                        ...
                        this.append(additionalButtonsArea, buttonAddTwo);

...
export default class TabRecord extends Tdg {
    ...
    init = () => {
        ...
        self.Ussd.TabRecord = this.CreateElement({
            element: "div",
            style: {
                gap: '10px',
                display: 'grid',
        ...
        this.state.fieldSet = self.Ussd.TabRecord;

        this.append(this.state.interfaceName, this.state.fieldSet);

        this.append(self.Ussd.TabRecord, this.buildRecords());
        this.append(self.Ussd.TabRecord, this.buildIncCall());
        this.append(self.Ussd.TabRecord, this.buildOutcCall());
    ...
    destroy = () => {
        ...
        if (!self.Ussd.TabMail) return false;
        self.Ussd.TabMail.remove();

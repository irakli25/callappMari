...
export default class TabHistory extends Tdg {
    ...
    init = () => {
        ...
        self.Ussd.History = this.CreateElement({
            element: "div",
            attributes: ["fieldset"],
            class: "historyTab",
            title: "ისტორია",
        ...
        this.state.fieldSet = self.Ussd.History;
    ...
    destroy = () => {
        ...
        if (!self.Ussd.History) return false;
        self.Ussd.History.remove();

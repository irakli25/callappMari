...
export default class TabQuestion extends Tdg {
    ...
    constructor() {
        ...
        self.Ussd.tab = [];
        self.Ussd.tab.TabQuestion = this;
    ...
    init = () => {
        ...
        self.Ussd.TabQuestion = this.CreateElement({
            element: "div",
            attributes: ["fieldset"],
            title: "კითხვა",
            style: {
        ...
        this.state.fieldSet = self.Ussd.TabQuestion;
    ...
    destroy = () => {
        ...
        if (!self.Ussd.TabQuestion) return false;
        self.Ussd.TabQuestion.remove();

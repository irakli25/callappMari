...
export default class Task_report_status extends Tdg {

  constructor() {
    super();

    this.state = {
      sectionName: document.querySelector("section[Task_report_status]"),
      element: [],
      level: 1
    }
  ...
  createTitle = () => {
    this.state.element.title = this.CreateElement({
        element: "h1",
        class: "title",
        children: "დავალებები სტატუსების მიხედვით"
    })

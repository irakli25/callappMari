    ...
    Core.prototype.positionButtons = function (activeAddon) {
        ...
        if ($p.length) {
            ...
            if (activeAddon) {
                ...
                position.left += -parseInt($buttons.find('.medium-insert-buttons-addons').css('left'), 10) - parseInt($buttons.find('.medium-insert-buttons-addons button:first').css('margin-left'), 10) - 60;
